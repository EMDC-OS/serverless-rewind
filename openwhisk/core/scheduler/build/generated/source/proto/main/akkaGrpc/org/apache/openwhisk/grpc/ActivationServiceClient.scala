...
object ActivationServiceClient {
  def apply(settings: GrpcClientSettings)(implicit mat: Materializer, ex: ExecutionContext): ActivationServiceClient =
    new DefaultActivationServiceClient(settings)
}

final class DefaultActivationServiceClient(settings: GrpcClientSettings)(implicit mat: Materializer, ex: ExecutionContext) extends ActivationServiceClient {
  ...
  private val clientState = new ClientState(settings)
    ...
    private def fetchActivationRequestBuilder(channel:scala.concurrent.Future[ManagedChannel]) = {
      
        new ScalaUnaryRequestBuilder(fetchActivationDescriptor, channel, options, settings)
      
    }
  
    private def rescheduleActivationRequestBuilder(channel:scala.concurrent.Future[ManagedChannel]) = {
     ...
     */
      ...
      override def fetchActivation(): SingleResponseRequestBuilder[org.apache.openwhisk.grpc.FetchRequest, org.apache.openwhisk.grpc.FetchResponse] =
        clientState.withChannel(fetchActivationRequestBuilder _)
     ...
     */
      ...
      override def rescheduleActivation(): SingleResponseRequestBuilder[org.apache.openwhisk.grpc.RescheduleRequest, org.apache.openwhisk.grpc.RescheduleResponse] =
        clientState.withChannel(rescheduleActivationRequestBuilder _)
