...
final case class RescheduleResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[RescheduleResponse] with scalapb.lenses.Updatable[RescheduleResponse] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.apache.openwhisk.grpc.RescheduleResponse = {
      var __isRescheduled = this.isRescheduled
      var _done__ = false
      while (!_done__) {
...
object RescheduleResponse extends scalapb.GeneratedMessageCompanion[org.apache.openwhisk.grpc.RescheduleResponse] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): org.apache.openwhisk.grpc.RescheduleResponse = {
