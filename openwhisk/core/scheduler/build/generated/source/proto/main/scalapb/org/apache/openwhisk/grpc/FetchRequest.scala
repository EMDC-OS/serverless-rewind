...
final case class FetchRequest(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.apache.openwhisk.grpc.FetchRequest = {
      ...
      var __warmed = this.warmed
      var __lastDuration = this.lastDuration
      var __alive = this.alive
      var _done__ = false
      while (!_done__) {
        ...
        _tag__ match {
          case 0 => _done__ = true
          case 10 =>
            __transactionId = _input__.readString()
          case 18 =>
          ...
          case 42 =>
            __containerId = _input__.readString()
          case 48 =>
...
object FetchRequest extends scalapb.GeneratedMessageCompanion[org.apache.openwhisk.grpc.FetchRequest] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): org.apache.openwhisk.grpc.FetchRequest = {
    ...
    org.apache.openwhisk.grpc.FetchRequest(
      ...
      __fieldsMap.get(__fields.get(6)).asInstanceOf[_root_.scala.Option[com.google.protobuf.wrappers.Int64Value]].map(org.apache.openwhisk.grpc.FetchRequest._typemapper_lastDuration.toCustom),
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.apache.openwhisk.grpc.FetchRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.apache.openwhisk.grpc.FetchRequest(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).flatMap(_.as[_root_.scala.Option[com.google.protobuf.wrappers.Int64Value]]).map(org.apache.openwhisk.grpc.FetchRequest._typemapper_lastDuration.toCustom),
